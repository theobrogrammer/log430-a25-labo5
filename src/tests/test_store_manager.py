...
def test_stock_flow(client):
    ...
    print(f"Set stock to 5 units for product {product_id}")
    ...
    print(f"Stock verified: {stock_data['quantity']} units")
    ...
    print(f"Stock after order: {stock_data['quantity']} units")